    ...
    return (
        <div className='main-animation'>
            ...
            <Form onSubmit={submitData}>
                ...
                <Card className="card-main-content">
                    <Card.Body>
                        <h4 className="card-main-content-title">Akses Pengguna</h4>
                        <p className="card-main-content-subtitle">Silahkan masukkan role dan akses yang pengguna miliki pada formulir dibawah ini.</p>

                        <Form.Group as={Row} className="mb-4">
                            <p style={{ fontWeight: 'bold' }}>Role Pengguna</p>
                            <Form.Label column sm="3">
                                Role
                            </Form.Label>
                            <Col sm="9">
                                <Select
                                    ...
                                    options={[{ value: '1', label: 'Akses Penuh' }]}
                                />
                            </Col>
                        </Form.Group>
                        ...
                        <table style={{ width: '100%' }}>
                            <thead>
                                <tr>
                                    <th width="250"><p>Nama Akses</p></th>
                                    <th className="text-center"><p>Create</p></th>
                                    <th className="text-center"><p>Read</p></th>
                                    <th className="text-center"><p>Update</p></th>
                                    <th className="text-center"><p>Delete</p></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
